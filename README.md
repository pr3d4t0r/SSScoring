% ssscoring(3) Version 3.0.7 | Speed Skydiving Scoring API documentation
...
- **[SSScore for Mac (universal .dmg)](https://github.com/pr3d4t0r/SSScoring/releases/latest/download/SSScore-3.0.7.dmg)**
- **[SSScore for Windows (installer)](https://github.com/pr3d4t0r/SSScoring/releases/latest/download/SSScore-3.0.7-Setup.exe)**
...
-rw-r--r--@ 1 ciurana  staff  190369691 May 23 09:06 SSScore-3.0.7.dmg
drwxr-xr-x  3 ciurana  staff         96 May 23 08:51 SSScore.app
-rw-r--r--  1 ciurana  staff      55699 May 23 08:46 ssscoring-2.98.97-py3-none-any.whl
...
-rwxr-xr-x 1 crystal None 79116394 May 23 12:44 SSScore-3.0.7-Setup.exe
...
- `SSScore-3.0.7-Setup.exe` standard installer
