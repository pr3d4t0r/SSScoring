...
-- Function to check if the SATSMARTDriver is loaded
...
-- Function to show a warning dialog with confirmation
...
-- Function to securely run sudo command using AppleScript
